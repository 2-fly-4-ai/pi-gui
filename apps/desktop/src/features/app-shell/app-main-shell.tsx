  ...
  return (
    <AppShell
      ...
      topbarProps={{
        ...
        onGitOpenPullRequests: snapshot.activeView === "threads" ? () => onSetActiveView("pull-requests") : undefined,
        currentPullRequest: gitActions.currentPullRequest,
        sourceControlAuthState: gitActions.sourceControlAuthState,
        updateStatus,
