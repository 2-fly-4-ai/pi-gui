...
- 2026-07-21 closeout verification is green: lint, typecheck, build, 73 unit tests, 155/155 core Electron tests, 32/32 credential-free live Electron tests (6 real-provider tests skipped by contract), 8/8 native Electron tests, packaged-app smoke, packaged-runtime dependency verification, and extracted release-zip smoke. GitHub Actions also passed gitleaks, lint, typecheck, unit, 155/155 macOS Electron core tests, and Linux AppImage packaging. Credential-gated and signing lanes remain separate external proofs.
