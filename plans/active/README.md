...
- Still product work: agents/subagents W1/W3/W4/W5-W7 follow-ups around audit correlation, multi-role/multi-child aggregation, structured workflow metadata, full transcript side-drawer, user-defined workflows, role hygiene, and observability upgrades. Display Mode durable-run backfill, live artifact scanning, and active-run cancel controls for workflow runs are implemented.
