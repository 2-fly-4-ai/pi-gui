...
- Still product work: agents/subagents W1/W3/W4/W6-W7 follow-ups around audit correlation, multi-role/multi-child aggregation, full transcript side-drawer, role hygiene, and observability upgrades. Structured workflow metadata, Display Mode durable-run backfill, live artifact scanning, active-run cancel controls, and user-defined workflow templates for workflow runs are implemented.
